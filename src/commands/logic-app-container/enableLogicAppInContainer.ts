...
export async function enableLogicAppInContainer(tree: LogicAppsContainerTreeDataProvider, node: TreeItemBase | undefined): Promise<void> {
    ...
    const options: vscode.ProgressOptions = {
        ...
        title: localize("azLogicAppContainers.enablingLogicApp", "Enabling Logic App...")
    };
