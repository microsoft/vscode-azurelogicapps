...
export async function disableLogicAppInContainer(tree: LogicAppsContainerTreeDataProvider, node: TreeItemBase | undefined): Promise<void> {
    ...
    const options: vscode.ProgressOptions = {
        ...
        title: localize("azLogicAppContainers.disablingLogicApp", "Disabling Logic App...")
    };
